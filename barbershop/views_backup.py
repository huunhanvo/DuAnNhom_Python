...
def api_schedule_day_detail(request, date_str):
    ...
    return JsonResponse({'success': False, 'message': 'Method not allowed'})d e f   t e s t _ a v a t a r ( r e q u e s t ) :  
         " " " T e s t   a v a t a r   d i s p l a y " " "  
         u s e r _ i d   =   r e q u e s t . s e s s i o n . g e t ( ' u s e r _ i d ' ,   2 )   #   D e f a u l t   t o   t e s t   u s e r  
         u s e r   =   g e t _ o b j e c t _ o r _ 4 0 4 ( N g u o i D u n g ,   i d = u s e r _ i d ,   d a _ x o a = F a l s e )  
          
         s t a f f _ i n f o   =   N o n e  
         t r y :  
                 s t a f f _ i n f o   =   T h o n g T i n N h a n V i e n . o b j e c t s . g e t ( n g u o i _ d u n g = u s e r ,   d a _ x o a = F a l s e )  
         e x c e p t   T h o n g T i n N h a n V i e n . D o e s N o t E x i s t :  
                 p a s s  
          
         #   S t a f f   c o n t e x t   f o r   t e m p l a t e  
         s t a f f _ c o n t e x t   =   {  
                 ' h o _ t e n ' :   u s e r . h o _ t e n ,  
                 ' s o _ d i e n _ t h o a i ' :   u s e r . s o _ d i e n _ t h o a i ,  
                 ' e m a i l ' :   u s e r . e m a i l ,  
                 ' a n h _ d a i _ d i e n ' :   u s e r . a n h _ d a i _ d i e n   i f   u s e r . a n h _ d a i _ d i e n   e l s e   N o n e ,  
         }  
          
         c o n t e x t   =   {  
                 ' u s e r ' :   u s e r ,  
                 ' s t a f f _ i n f o ' :   s t a f f _ i n f o ,  
                 ' s t a f f ' :   s t a f f _ c o n t e x t ,  
         }  
         r e t u r n   r e n d e r ( r e q u e s t ,   ' t e s t _ a v a t a r . h t m l ' ,   c o n t e x t )  
 
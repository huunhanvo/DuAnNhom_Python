...
from .models import (
    ...
    LichLamViec, DatLich, DichVuDatLich,
...
# ========== BẮT ĐẦU - Di chuyển tới core/decorators.py ==========
# HƯỚNG DẪN: 2 decorators dưới đây ĐÃ ĐƯỢC COPY SẴN vào core/decorators.py
# Bạn KHÔNG CẦN di chuyển, CHỈ XÓA sau khi hoàn tất refactor
# Giữ lại tạm thời để barbershop/views.py vẫn hoạt động
...
# =============================================
# INVENTORY MANAGEMENT - COMMENTED OUT
# Inventory module has been removed from the system
# =============================================
# @require_role(['quan_ly'])
